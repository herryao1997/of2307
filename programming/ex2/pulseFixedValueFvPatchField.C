...
pulseFixedValueFvPatchField(
        ...
        : fixedValueFvPatchField<Type>(p, iF),
          period_(dict.getOrDefault<scalar>("period", 0.0)),
          duration_(dict.getOrDefault<scalar>("duration", 0.0)),
        ...
        Ostream &os) const
{
    ...
    os.writeEntry( "baseValue", baseValue_);
    os.writeEntry( "pulseValue", pulseValue_);
}
